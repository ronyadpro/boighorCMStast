<section class="content">
	<div class="container-fluid">
		...
		<div class="row pt-3">
			<div class="col-sm-6">
				<h3 class="m-0 text-dark">Api Log Details</h3>
			</div>
			<div class="col-sm-6">
		...
		<div class="row">
			<div class="col-sm-1">
				<button type="button" class="btn btn-primary" id="btn_refresh">Refresh</button>
			</div>
		</div>
	</div>
</section>
...
$('#navlink_apilog_boighorglobal').addClass('active');
...
$('#logdate').change(function(e) {
	$.ajax({
		url: "<?= base_url('devlog/get_logdetails_apilog') ?>",
		type: "POST",
		data: {
			date: $('#logdate').val()
		},
