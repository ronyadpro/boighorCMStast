            ...
            <div class="col-sm-12 mb-2 mt-2">
                <!-- <div class="row"> -->
                    <div class="btn-group float-right">
                        <button id="btn_add" class="btn btn-sm btn-outline-secondary" data-toggle="modal" data-target="#modal-add-section" type="button" id="button"><i class="fas fa-book"></i>  Add Book Row </button>
                        <button id="btn_add_single_book" class="btn btn-sm btn-outline-secondary" data-toggle="modal" data-target="#modal-add-single-book" type="button" id="button"><i class="fas fa-book"></i>  Add Single Book </button>
                        <button id="btn_add_author" class="btn btn-sm btn-outline-secondary" data-toggle="modal" data-target="#modal-add-author" type="button"><i class="fas fa-user-plus"></i> Add Author Row </button>
                    </div>

                    <ul class="nav nav-tabs" id="nav-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#nav-blank" role="tab" aria-controls="nav-blank" aria-selected="true"><span style="color : #3a3a3a">&nbsp;</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#nav-active" role="tab" aria-controls="nav-active" aria-selected="true"><span style="color : #3a3a3a"><i class="fas fa-broadcast-tower mr-2"></i>Active</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#nav-archive" role="tab" aria-controls="nav-archive"><span style="color : #3a3a3a"><i class="fas fa-archive mr-2"></i>Archive</span></a>
                        </li>
                    </ul>
                <!-- </div> -->
                <div class="row">
                    <div class="col-12">
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-active" role="tabpanel">
                                <table id="tbl_cur_home_active" class="table table-hover" width="100%"></table>
                            </div>
                            <div class="tab-pane fade" id="nav-archive" role="tabpanel">
                                <table id="tbl_cur_home_archive" class="table table-hover" width="100%"></table>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-control" id="ddl_type" required readonly>
...
<div class="modal fade" id="modal-add-single-book">
    <div class="modal-dialog modal-xl">
        <div class="modal-content bg-gradient-light">
            <div class="modal-header">
                <h4 class="modal-title" id="modal-add-section-title">Add Single Book Row</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="frm_new_section_single_book" method="post">
                    <input type="hidden" name="" id="ddl_type_single" value="2">
                    <div class="card">
                        <div class="card-body">
                            <label>Information :</label>
                            <div class="row">
                                <div class="col-3">
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="txt_catname_en_single" maxlength="50" type="text" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="txt_catname_bn_single" maxlength="50" type="text" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="input-group mb-3">
                                        ...
                                        <input required id="txt_catcode_single" maxlength="20" type="text" class="form-control" pattern="^[a-z-]+$">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="input-group mb-3">
                                        ...
                                        <input required id="txt_bookcode_single" maxlength="20" type="text" class="form-control" pattern="^[A-Za-z0-9]+$">
                                    </div>
                                </div>
                            </div>
                            <button type="submit" class="btn btn-block btn-primary w-50" name="button"> <i class="fas fa-save"></i> Save</button>
                        </div>
                    </div>
                </form>
            </div>
...
<div class="modal fade" id="modal-add-single-book-edit">
    <div class="modal-dialog modal-xl">
        <div class="modal-content bg-gradient-light">
            <div class="modal-header">
                <h4 class="modal-title" id="modal-add-section-title">Edit Single Book Row</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="frm_edit_section_single_book" method="post">
                    <input type="hidden" name="type" id="ddl_type_single_edit" value="2">
                    <div class="card">
                        <div class="card-body">
                            <label>Information :</label>
                            <div class="row">
                                <div class="col-3">
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="txt_catname_en_single_edit" maxlength="50" type="text" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="txt_catname_bn_single_edit" maxlength="50" type="text" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="input-group mb-3">
                                        ...
                                        <input required id="txt_catcode_single_edit" maxlength="20" type="text" class="form-control" pattern="^[a-z-]+$" readonly>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="input-group mb-3">
                                        ...
                                        <input required id="txt_bookcode_single_edit" maxlength="20" type="text" class="form-control" pattern="^[A-Za-z0-9]+$">
                                    </div>
                                </div>
                            </div>
                            <button type="submit" class="btn btn-block btn-primary" name="button"> <i class="fas fa-save"></i> Save</button>
                        </div>
                    </div>
                </form>
            </div>
...
$('#navlink_curation_global').addClass('active');
...
$('#tbl_cur_home_archive').DataTable( {
    processing: true,
    serverSide: true,
    stateSave: true,
    ordering: false,
    ...
    lengthMenu: [[-1], ["All"]],
    ajax: {
        url: "<?= base_url('curation_global/getHomeData_archived'); ?>",
        type: 'POST',
    ...
    columns: [
        ...
        },
        {
            ...
            render: function (data, type, service) {
                return "<button onclick='unarchiveItem(\""+data+"\")' class='btn btn-sm pt-0 pb-0 text-success' type='button'><i class='fas fa-undo text-success mr-1'></i>Unarchive</button>";
            }
        },
    ],
...
//      HOME
table = $('#tbl_cur_home_active').DataTable( {
    processing: true,
    serverSide: true,
    stateSave: true,
    ordering: false,
    ...
    lengthMenu: [[-1], ["All"]],
    ajax: {
        url: "<?= base_url('curation_global/getHomeData'); ?>",
        type: 'POST',
        dataFilter: function(data){
            // console.log(jQuery.parseJSON(data));
            sl = jQuery.parseJSON(data)['start'];
            currentDataSet_active = jQuery.parseJSON(data)['data'];
            return data;
        },
        error: function(err){
            console.log(err);
    ...
    columns: [
        ...
        {
            "title": "Web",
            "data": { catcode: "catcode", status: "showitem"},
            render: function (data, type, service) {
                var id = "showitem_"+data['catcode'];
                return '<div class="custom-control custom-switch"><input type="checkbox" '+(data['showitem'] == '1' ? 'checked' : '')+' class="custom-control-input" id="'+id+'"><label class="custom-control-label" for="'+id+'"></label></div>';
            }
        },
        {
            "title": "Android",
            "data": { catcode: "catcode", status: "showinapp"},
            render: function (data, type, service) {
                var id = "showinapp_"+data['catcode'];
                return '<div class="custom-control custom-switch"><input type="checkbox" '+(data['showinapp'] == '1' ? 'checked' : '')+' class="custom-control-input" id="'+id+'"><label class="custom-control-label" for="'+id+'"></label></div>';
            }
        },
        {
            "title": "iOS",
            "data": { catcode: "catcode", status: "showinios"},
            render: function (data, type, service) {
                var id = "showinios_"+data['catcode'];
                return '<div class="custom-control custom-switch"><input type="checkbox" '+(data['showinios'] == '1' ? 'checked' : '')+' class="custom-control-input" id="'+id+'"><label class="custom-control-label" for="'+id+'"></label></div>';
            }
        },
        {
            "title": "Action",
            ...
            render: function (data, type, service) {
                switch (data['itemtype']) {
                    ...
                    case '2':
                        return "<button data-toggle='modal' data-target='#modal-add-section' onclick='populateEditSectionItems(\""+data['catcode']+"\", true)' class='btn btn-sm pt-0 pb-0' type='button' id='"+data['catcode']+"_"+sl+"'><i class='fas fa-edit text-secondary'></i> Edit</button>";
                        break;
                        // return "<button data-toggle='modal' data-target='#modal-add-single-book-edit' onclick='populateEditSingleBook(\""+data['catcode']+"\", true)' class='btn btn-sm pt-0 pb-0' type='button' id='"+data['catcode']+"_"+sl+"'><i class='fas fa-edit text-secondary'></i> Edit</button>";\
                    default:
        ...
        },
        {
            ...
            "data": "catcode",
            render: function (data, type, service) {
                return "<button onclick='archiveItem(\""+data+"\")' class='btn btn-sm pt-0 pb-0 text-danger' type='button'><i class='fas fa-archive text-danger mr-1'></i>Archive</button>";
            }
        },
    ],
    fnInfoCallback: function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
...
table.on( 'row-reorder', function ( e, diff, edit ) {
    ...
    $.ajax({
        url: "<?php echo base_url();?>curation_global/reorderhomedata",
        method:"POST",
        data: data,
...
$('#tbl_cur_home_active thead').css("background-color", "#rgb(222, 226, 230)");

function changeStatus(platform, catcode, status) {
    // console.log(platform, catcode, status);
    $.ajax({
        url: "<?=base_url('curation_global/changeStatus')?>",
        method:"POST",
        data: {
            catcode: catcode,
            platform: platform,
...
function archiveItem(catcode) {
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: "<?=base_url('curation_global/archiveItem')?>",
                method:"POST",
                data: {
                    catcode: catcode,
                },
                success:function(data) {
                    ...
                    if (data) {
                        ...
                        toastr.success('Archive Unsuccessful')
                    }
                },
                error: function() {
                    Toast.fire({
...
function unarchiveItem(catcode) {
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: "<?=base_url('curation_global/unarchiveItem')?>",
                method:"POST",
                data: {
                    catcode: catcode,
                },
...
curatedTable.on( 'row-reorder', function ( e, diff, edit ) {
    if ($('#btn_create_section').attr('name') == 'btn_update') {
        ...
        console.log(data);
        $.ajax({
            url: "<?php echo base_url();?>curation_global/updateSectionSortorder",
            method:"POST",
            data: data,
            success:function(data) {
                console.log(data);
...
$( "#btn_cat_gen_search" ).click(function() {
    ...
    searchResultTable = $('#tbl_new_section_result').DataTable( {
        ...
        ajax: {
            url: "<?php echo base_url(); ?>curation_global/getBooklist",
            type: 'POST',
            data: {
    ...
    drop: function (event, ui) {
        ...
        if (!dupFlag) {
            if ($('#btn_create_section').attr('name') == 'btn_update') {    //  BOOKS
                $.ajax({
                    url: "<?php echo base_url();?>curation_global/addSectionItem",
                    method:"POST",
                    data: {
...
$('#frm_new_section').on('submit', function(e) {
    ...
    if (btn_name == 'btn_update') {
        ...
        $.ajax({
            url: "<?php echo base_url() ?>curation_global/editSectionInfo",
            method: "POST",
            data: {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "<?php echo base_url() ?>curation_global/createSection",
                    method: "POST",
                    data: {
                        catname : $('#txt_catname_en').val(),
                        catname_bn: $('#txt_catname_bn').val(),
...
$('#frm_new_section_single_book').on('submit', function(e) {
    e.preventDefault();
    Swal.fire({
        title: 'Create New Section?',
        type: "question",
        ...
        if (result.value) {
            $.ajax({
                url: "<?php echo base_url() ?>curation_global/createSectionSingleBook",
                method: "POST",
                data: {
                    catname : $('#txt_catname_en_single').val(),
                    catname_bn: $('#txt_catname_bn_single').val(),
                    catcode: $('#txt_catcode_single').val(),
                    itemtype: $('#ddl_type_single').val(),
                    bookcodes: [$('#txt_bookcode_single').val()],
                },
                success:function(data) {
                    console.log(data);
                    if (data == 1) {
...
$('#frm_edit_section_single_book').on('submit', function(e) {
    e.preventDefault();
    Swal.fire({
        title: 'Save Changes?',
        type: "question",
        ...
        if (result.value) {
            $.ajax({
                url: "<?php echo base_url() ?>curation_global/editSectionSingleBook",
                method: "POST",
                data: {
                    catname : $('#txt_catname_en_single_edit').val(),
                    catname_bn: $('#txt_catname_bn_single_edit').val(),
                    catcode: $('#txt_catcode_single_edit').val(),
                    itemtype: $('#ddl_type_single_edit').val(),
                    bookcode: $('#txt_bookcode_single_edit').val(),
                },
                success:function(data) {
                    console.log(data);
...
function clear_single_row(rowId) {
    if ($('#btn_create_section').attr('name') == 'btn_update') {
        ...
        $.ajax({
            url: "<?php echo base_url();?>curation_global/removeSectionItem",
            method:"POST",
            data: {
                catcode : catcode_being_edited,
...
function populateEditSectionItems(catcode, shouldCleanSearchData = false) {
    ...
    $.ajax({
        url: "<?php echo base_url();?>curation_global/getSectionItems",
        method:"POST",
        data: {
            catcode: catcode
        },
        success:function(data) {
            ...
            for (var row in books) {
                ...
                html += '<tr id="'+books[row]['bookcode']+'" role="row" class="odd"><td class="reorder text-center sorting_1">'+(parseInt(row)+1)+'</td><td><img width="50px" src="https://d1b3dh5v0ocdqe.cloudfront.net/media/book_th/'+books[row]['bookcover_small']+'"></td><td>'+books[row]['bookcode']+'</td><td>'+books[row]['bookname']+'</td><td>'+books[row]['writer']+'</td><td><i class="fas fa-minus-circle fa-2x text-danger" onclick="clear_single_row(\''+books[row]['bookcode']+'\')"></i></td></tr>';
            }
        ...
        columns: [
            ...
            },
            {
                ...
                render: function (data, type, service) {
                    ...
                    return '<img width="50px" src="https://d1b3dh5v0ocdqe.cloudfront.net/media/author_th/'+data+'.jpg" onerror="'+placeholderImg+'" />';
                }
            },
            {
                "title": "Code",
...
function populateEditSingleBook(singleBookRowCatcode) {
    singleBookRow = currentDataSet_active.find((row) => {
        return row.catcode == singleBookRowCatcode;
    });
    $('#txt_catname_en_single_edit').val(singleBookRow.catname);
    $('#txt_catname_bn_single_edit').val(singleBookRow.catname_bn);
    $('#txt_catcode_single_edit').val(singleBookRow.catcode);

    $.ajax({
        url: "<?php echo base_url();?>curation_global/getSectionItems",
        method:"POST",
        data: {
            catcode: singleBookRowCatcode
        },
        success:function(data) {
            data = JSON.parse(data);
            $('#txt_bookcode_single_edit').val(data['books'][0]['bookcode']);
        }
    });
}
