...
$('#navlink_curation_robi').addClass('active');
...
$('#tbl_cur_home_archive').DataTable( {
    ...
    lengthMenu: [[-1], ["All"]],
    ajax: {
        url: "<?= base_url('curation_robi/getHomeData_archived'); ?>",
        type: 'POST',
...
table = $('#tbl_cur_home_active').DataTable( {
    ...
    lengthMenu: [[-1], ["All"]],
    ajax: {
        url: "<?= base_url('curation_robi/getHomeData'); ?>",
        type: 'POST',
        dataFilter: function(data){
            // console.log(jQuery.parseJSON(data));
            sl = jQuery.parseJSON(data)['start'];
...
table.on( 'row-reorder', function ( e, diff, edit ) {
    ...
    $.ajax({
        url: "<?php echo base_url();?>curation_robi/reorderhomedata",
        method:"POST",
        data: data,
...
function changeStatus(platform, catcode, status) {
    ...
    $.ajax({
        url: "<?=base_url('curation_robi/changeStatus')?>",
        method:"POST",
        data: {
            catcode: catcode,
            platform: platform,
...
function archiveItem(catcode) {
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: "<?=base_url('curation_robi/archiveItem')?>",
                method:"POST",
                data: {
                    catcode: catcode,
                },
...
function unarchiveItem(catcode) {
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: "<?=base_url('curation_robi/unarchiveItem')?>",
                method:"POST",
                data: {
                    catcode: catcode,
                },
...
curatedTable.on( 'row-reorder', function ( e, diff, edit ) {
    if ($('#btn_create_section').attr('name') == 'btn_update') {
        ...
        console.log(data);
        $.ajax({
            url: "<?php echo base_url();?>curation_robi/updateSectionSortorder",
            method:"POST",
            data: data,
            success:function(data) {
                console.log(data);
...
$( "#btn_cat_gen_search" ).click(function() {
    ...
    searchResultTable = $('#tbl_new_section_result').DataTable( {
        ...
        ajax: {
            url: "<?php echo base_url(); ?>curation_robi/getBooklist",
            type: 'POST',
            data: {
    ...
    drop: function (event, ui) {
        ...
        if (!dupFlag) {
            if ($('#btn_create_section').attr('name') == 'btn_update') {    //  BOOKS
                $.ajax({
                    url: "<?php echo base_url();?>curation_robi/addSectionItem",
                    method:"POST",
                    data: {
...
$('#frm_new_section').on('submit', function(e) {
    ...
    if (btn_name == 'btn_update') {
        ...
        $.ajax({
            url: "<?php echo base_url() ?>curation_robi/editSectionInfo",
            method: "POST",
            data: {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "<?php echo base_url() ?>curation_robi/createSection",
                    method: "POST",
                    data: {
                        catname : $('#txt_catname_en').val(),
                        catname_bn: $('#txt_catname_bn').val(),
...
function clear_single_row(rowId) {
    if ($('#btn_create_section').attr('name') == 'btn_update') {
        ...
        $.ajax({
            url: "<?php echo base_url();?>curation_robi/removeSectionItem",
            method:"POST",
            data: {
                catcode : catcode_being_edited,
...
function populateEditSectionItems(catcode, shouldCleanSearchData = false) {
    ...
    $.ajax({
        url: "<?php echo base_url();?>curation_robi/getSectionItems",
        method:"POST",
        data: {
            catcode: catcode
        },
