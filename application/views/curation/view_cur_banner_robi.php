<div class="content-header">
    <div class="container-fluid">
        ...
        <table id="tbl_cur_banner_robi" class="table table-hover" width="100%"></table>
...
$('#navlink_banner_robi').addClass('active');
...
table = $('#tbl_cur_banner_robi').DataTable( {
    processing: true,
    serverSide: true,
    ordering: false,
    responsive: false,
    ...
    lengthMenu: [[-1], ["All"]],
    ajax: {
        url: "<?php echo base_url(); ?>curation_robi/get_banner_items",
        type: 'POST',
    ...
    columns: [
        ...
        },
        {
            ...
            render: function (data) {
                return '<img src="https://bangladhol.com/banner_th/robi/'+data+'" alt="Smiley face" height="42">';
            },
        },
        {
            "title": "Mobile",
    ...
    fnInfoCallback: function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
        ...
        $('button[name=btn_status]').on('click', function(e) {
            Swal.fire({
                ...
                preConfirm: (data) => {
                    return $.ajax({
                        url: "<?php echo base_url() ?>curation_robi/change_banner_item_status",
                        method: "POST",
                        data: {
        ...
        $('button[name=btn_delete]').on('click', function(e) {
            Swal.fire({
                ...
                preConfirm: (data) => {
                    return $.ajax({
                        url: "<?php echo base_url() ?>curation_robi/delete_banner_item",
                        method: "POST",
                        data: {
                            id: this.id.split("_").reverse()[0]
                        },
...
table.on( 'row-reorder', function ( e, diff, edit ) {
    ...
    $.ajax({
        url: "<?php echo base_url();?>curation_robi/reorder_banner",
        method:"POST",
        data: data,
        success:function(data) {
            // console.log(data);
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url() ?>curation_robi/add_banner_item",
                method: "POST",
                data: form_data,
                contentType: false,
                processData: false,
...
$('#frm_edit_banner_item').on('submit', function(e) {
    ...
    Swal.fire({
        ...
        preConfirm: (data) => {
            return $.ajax({
                url: "<?php echo base_url() ?>curation_robi/update_banner_item",
                method: "POST",
                data: formData,
                processData: false,
                contentType: false,
