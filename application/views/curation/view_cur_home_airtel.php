...
<?php if ($userinfo['username'] == ''): ?>
    Swal.fire({
        title: 'This page in under development',
        text: 'Do not use this module',
        type: "warning",
...
$('#navlink_curation_airtel').addClass('active');
...
$('#tbl_cur_home_archive').DataTable( {
    ...
    lengthMenu: [[-1], ["All"]],
    ajax: {
        url: "<?= base_url('curation_airtel/getHomeData_archived'); ?>",
        type: 'POST',
...
table = $('#tbl_cur_home_active').DataTable( {
    ...
    lengthMenu: [[-1], ["All"]],
    ajax: {
        url: "<?= base_url('curation_airtel/getHomeData'); ?>",
        type: 'POST',
        dataFilter: function(data){
            // console.log(jQuery.parseJSON(data));
            sl = jQuery.parseJSON(data)['start'];
...
table.on( 'row-reorder', function ( e, diff, edit ) {
    ...
    $.ajax({
        url: "<?php echo base_url();?>curation_airtel/reorderhomedata",
        method:"POST",
        data: data,
...
function changeStatus(platform, catcode, status) {
    ...
    $.ajax({
        url: "<?=base_url('curation_airtel/changeStatus')?>",
        method:"POST",
        data: {
            catcode: catcode,
            platform: platform,
...
function archiveItem(catcode) {
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: "<?=base_url('curation_airtel/archiveItem')?>",
                method:"POST",
                data: {
                    catcode: catcode,
                },
...
function unarchiveItem(catcode) {
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: "<?=base_url('curation_airtel/unarchiveItem')?>",
                method:"POST",
                data: {
                    catcode: catcode,
                },
...
curatedTable.on( 'row-reorder', function ( e, diff, edit ) {
    if ($('#btn_create_section').attr('name') == 'btn_update') {
        ...
        console.log(data);
        $.ajax({
            url: "<?php echo base_url();?>curation_airtel/updateSectionSortorder",
            method:"POST",
            data: data,
            success:function(data) {
                console.log(data);
...
$( "#btn_cat_gen_search" ).click(function() {
    ...
    searchResultTable = $('#tbl_new_section_result').DataTable( {
        ...
        ajax: {
            url: "<?php echo base_url(); ?>curation_airtel/getBooklist",
            type: 'POST',
            data: {
    ...
    drop: function (event, ui) {
        ...
        if (!dupFlag) {
            if ($('#btn_create_section').attr('name') == 'btn_update') {    //  BOOKS
                $.ajax({
                    url: "<?php echo base_url();?>curation_airtel/addSectionItem",
                    method:"POST",
                    data: {
...
$('#frm_new_section').on('submit', function(e) {
    ...
    if (btn_name == 'btn_update') {
        ...
        $.ajax({
            url: "<?php echo base_url() ?>curation_airtel/editSectionInfo",
            method: "POST",
            data: {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "<?php echo base_url() ?>curation_airtel/createSection",
                    method: "POST",
                    data: {
                        catname : $('#txt_catname_en').val(),
                        catname_bn: $('#txt_catname_bn').val(),
...
function clear_single_row(rowId) {
    if ($('#btn_create_section').attr('name') == 'btn_update') {
        ...
        $.ajax({
            url: "<?php echo base_url();?>curation_airtel/removeSectionItem",
            method:"POST",
            data: {
                catcode : catcode_being_edited,
...
function populateEditSectionItems(catcode, shouldCleanSearchData = false) {
    ...
    $.ajax({
        url: "<?php echo base_url();?>curation_airtel/getSectionItems",
        method:"POST",
        data: {
            catcode: catcode
        },
