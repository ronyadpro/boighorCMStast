                            ...
                            <div class="row justify-content-center">
                                <div class="input-group form-group col-12">
                                    ...
                                    <div class="custom-file">
                                        <input id="file_banner_web" type="file" name="file_banner_web" class="custom-file-input form-control-sm" accept=".png, .jpg, .jpeg" required>
                        ...
                        <div class="col-sm-6">
                            <div class="row justify-content-center">
                                <div class="input-group form-group col-12">
                                    ...
                                    <div class="custom-file">
                                        <input id="file_banner_mob" type="file" name="file_banner_mob" class="custom-file-input form-control-sm" accept=".png, .jpg, .jpeg" required>
    ...
    columns: [
        ...
        },
        {
            ...
            render: function (data) {
                return '<img src="https://d1b3dh5v0ocdqe.cloudfront.net/media/banner_th/gp/'+data+'" alt="Smiley face" height="42">';
            }
        },
        {
            "title": "Mobile",
    ...
    fnInfoCallback: function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
        ...
        $('button[name=btn_status]').on('click', function(e) {
            Swal.fire({
                ...
                preConfirm: (data) => {
                    return $.ajax({
                        url: "<?php echo base_url() ?>curation/change_banner_item_status/gp",
                        method: "POST",
                        data: {
        ...
        $('button[name=btn_delete]').on('click', function(e) {
            Swal.fire({
                ...
                preConfirm: (data) => {
                    return $.ajax({
                        url: "<?php echo base_url() ?>curation/delete_banner_item/gp",
                        method: "POST",
                        data: {
                            id: this.id.split("_").reverse()[0]
                        },
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url() ?>curation/add_banner_item/gp",
                method: "POST",
                data: form_data,
                contentType: false,
                processData: false,
...
$('#frm_edit_banner_item').on('submit', function(e) {
    ...
    Swal.fire({
        ...
        preConfirm: (data) => {
            return $.ajax({
                url: "<?php echo base_url() ?>curation/update_banner_item/gp",
                method: "POST",
                data: formData,
                processData: false,
                contentType: false,
