<section class="content">
	<div class="container-fluid">
		...
		<div class="row pt-3">
			<div class="col-sm-6">
				<h3 class="m-0 text-dark">Web Log Details</h3>
			</div>
			<div class="col-sm-6">
		...
		<div class="row justify-content-center">
			<div class="col-sm-3">
				...
				<input type="date" class="form-control" name="logdate" id="logdate" placeholder="Please select a date" />
...
$('#navlink_weblog_boighorglobal').addClass('active');
$('.loading').addClass('d-none');

$('#logdate').change(function(e) {
	$.ajax({
		url: "<?= base_url('devlog/get_logdetails_weblog') ?>",
		type: "POST",
		data: {
			date: $('#logdate').val()
		},
