        ...
        <div class="row mb-3">
            <div class="col-sm-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">In-app Images</li>
                </ol>
            </div>
            <div class="col-6">
        ...
        <div class="modal-content bg-light">
            ...
            <form id="frm_upload_notification_image" method="post">
                <div class="modal-body">
                    <div class="card-body">
                        <div class="row">
                            <h5>540x960 .PNG file only </h5><small class="ml-2">Max. 512KB</small>
                        </div>
                        <div class="row">
                            <div class="card" style="margin-bottom: 10px; padding: 0">
                                ...
                                <div class="card-body" style="padding-top: 0">
                                    ...
                                    <div class="custom-file" style="margin-bottom: 10px;">
                                        <input required id="file" name="file_upload" class="custom-file-input form-control-sm" type="file" accept=".png">
...
$('#navlink_in_app_image').addClass('active');
...
var table = $('#tbl_images').DataTable( {
    ...
    ajax: {
        url: "<?= base_url('in-app-image/get_inapp_images'); ?>",
        type: 'POST',
    ...
    columns: [
        ...
        },
        {
            ...
            render: function (filename, type, row) {
                return '<img src="https://d1b3dh5v0ocdqe.cloudfront.net/media/inapp/'+filename+'" width="50px">';
            }
        },
        {
            "title": "Image URL",
            "data": "filename",
            render: function (filename, type, row) {
                return "https://d1b3dh5v0ocdqe.cloudfront.net/media/inapp/"+filename;
            }
        },
        {
            "title": "createdby",
...
$('#file').change(function(e){
        ...
        img.onload = function() {
            if(
                ...
                $('#file').val('');
                Swal.fire("Incorrent resolution", "Image must be 540x960", "warning");
            }
        };
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                ...
                url: "<?= base_url('in-app-image/upload') ?>",
                method: "POST",
                data: form_data,
                contentType: false,
                processData: false,
