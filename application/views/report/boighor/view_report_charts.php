		...
		<div class="row">
			...
			<section class="col-sm-12">
				<div class="card card-light">
					<div class="card-header ui-sortable-handle">
                        <a data-toggle="tooltip" data-original-title="Daily number of new users in past 90 days(Boighor Global only)">
    						<h3 class="card-title">
                                <i class="fas fa-chart-bar mr-1"></i>
                                Daily New User
                    ...
                    <div class="card-body p-2">
                        <canvas id="cnv_daily_user" class="chartjs-render-monitor" height="50"></canvas>
					</div>
				</div>
			</section>
...
function daliy_new_user() {
    var cnv_daily_user = $('#cnv_daily_user').get(0).getContext('2d');
    var chart = new Chart(cnv_daily_user, {
        type: 'bar',
        data: {
            labels: <?= json_encode(array_column($daily_new_user,'date')) ?>,
            datasets: [
                {
                    label: 'New User',
                    backgroundColor: '#3b5998',
                    borderColor: '#3b5998',
                    data: <?= json_encode(array_column($daily_new_user,'count')) ?>
                },
            ]
        },
        options: {
