                                    ...
                                    <div class="row justify-content-center">
                                        <!-- <div class="input-group form-group">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text" style="width: 200px">Book Code<sup class="text-danger">*</sup></div>
                                            </div>
                                            <input type="text" class="form-control" id="txt_bookcode" placeholder="e.g. 0894AD11 or e5e59740" pattern="^[a-zA-Z0-9]{8}$" required>
                                        </div> -->
                                        ...
                                        <div class="input-group form-group">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text" style="width: 200px">Genre<sup class="text-danger">*</sup></div>
                                            </div>
                                        ...
                                        <div class="input-group form-group">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text" style="width: 200px">Price Local<sup class="text-danger">*</sup></div>
                                            </div>
                                        ...
                                        <div class="input-group form-group">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text" style="width: 200px">Price Global<sup class="text-danger">*</sup></div>
                                            </div>
    ...
    $('#frm_book_info').on('submit', function(e){
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    url: "<?php echo base_url() ?>book/addNewBookInfo",
                    type: "POST",
                    data: data,
                    success: function(data){
                        ...
                        if (data.length==8) {
                            Swal.fire("Done", "Book Added Successfully", "success").then((result) => {
                                document.location = "<?php echo base_url() ?>book/overview/"+data;
                            });
                        } else if (data==2) {
                            Swal.fire({
