                            ...
                            <ul class="nav nav-tabs" id="nav-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" id="nav-nav-info" data-toggle="tab" href="#nav-info" role="tab" aria-controls="nav-info" aria-selected="true">
                                        <span style="color : #3a3a3a"><i class="fab fa-leanpub mr-1"></i><b><?php echo $bookname_bn ?></b></span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                            ...
                                            <div class="col-2">
                                                <div class="card p-0 mb-3">
                                                    <div class="card-body p-0 m-0">
                                                        <img width="100%" class="img-border" src="<?php echo $file_plain ? "https://d1b3dh5v0ocdqe.cloudfront.net/media/book_th_plain/".$bookcover_small : base_url().'images/no_img.png'; ?>">
                                                    </div>
                                                </div>
                                                <?php if ($isaudiobook): ?>
                                                    <div class="card p-0 mb-3">
                                                        <div class="card-body p-0 m-0">
                                                            <img width="100%" class="img-border" src="<?php echo $file_square ? "https://d1b3dh5v0ocdqe.cloudfront.net/media/book_th_square/".$bookcover_square : base_url().'images/no_img_sq.png'; ?>">
                                                        </div>
                                                    </div>
                                                <?php endif; ?>
                                                <div class="card p-0 mb-3">
                                                    <div class="card-body p-0 m-0">
                                                        <img width="100%" class="img-border" src="<?php echo $file_share ? "https://d1b3dh5v0ocdqe.cloudfront.net/media/banner_fb/".$bookcode.'.png' : 'https://d1b3dh5v0ocdqe.cloudfront.net/media/banner_th/global/placeholder.png'; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-8">
                                                <div class="card card-outline card-primary">
                                                    <div class="card-header">
                                                        <div class="row justify-content-between">
                                                            <h3 class="card-title"><strong>Book Information</strong></h3>
                                                            <h3 class="card-title text-danger">
                                                                <i class="fas fa-heart mr-1"></i>
                                                                <strong class="mr-3"><?= $favouritecount ?></strong>
                                                            <!-- </h3>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <form id="frm_book_info" method="post">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="txt_isenglishbook">Language</label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="txt_booksummary">Summary</label>
                                                                        <textarea class="form-control" id="txt_booksummary" rows="<?php echo 8 //(strlen($booksummary)/180)+1; ?>"><?php echo $booksummary; ?></textarea>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="txt_writer">Title English</label>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control select2" name="txt_publisher" id="txt_publisher"></select>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="txt_genre">Genre</label>
                                                                    <select class="form-control select2" multiple="multiple" name="txt_genre" id="txt_genre" required></select>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="txt_book_page">Book Page Count</label>
                                                                    <input type="text" class="form-control" id="txt_book_page" placeholder="(Optional)" value="<?php echo $bookpage ?>">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="">Apple PID</label>
                                                                    <input type="text" class="form-control" id="txt_productid_appstore" placeholder="(Optional)" value="<?php echo $productid_appstore ?>">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="">Roalty (%)</label>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="txt_audiobookcode">Audiobook Bookcode</label>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group form-group">
                                                                        <div class="input-group-prepend">
                                                                            <div class="input-group-text prepend-short-20">at</div>
                                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <button type="submit" class="btn btn-outline-danger btn-block"><i class="fas fa-save mr-1"></i><b>Save Information</b></button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="small-box bg-info">
                                                            <div class="inner">
                                                                ...
                                                                <?php if ($isaudiobook): ?>
                                                                    <a href="<?php echo $adb_has_book ? base_url().'book/overview/'.$adb_has_book : '' ?>"></a>
                                                                <?php elseif (!$isaudiobook): ?>
                                                                    <a href="<?php echo $audiobookcode ? base_url().'book/overview/'.$audiobookcode : '' ?>"></a>
                                                                <?php endif; ?>
                                                        ...
                                                        <div class="small-box bg-<?php echo $status ? 'success' : 'danger' ?> d-none">
                                                            <div class="inner">
                                                        ...
                                                        <div class="small-box bg-<?php echo $globalstatus ? 'success' : 'danger' ?> d-none">
                                                            <div class="inner">
                                                        ...
                                                        <div class="card card-outline card-warning">
                                                            <div class="card-body">
                                                                <form id="frm_status" method="post">
                                                                    <div class="row">
                                                                        <div class="col-sm-12">
                                                                            <label class="mb-0">Boighor</label>
                                                                        </div>
                                                                        <div class="col-sm-12">
                                                                    ...
                                                                    <div class="row mt-3">
                                                                        <div class="col-sm-12">
                                                                            <label class="mb-0">GP Boimela</label>
                                                                        </div>
                                                                        <div class="col-sm-12">
                                                                    ...
                                                                    <div class="row mt-3">
                                                                        <div class="col-sm-12">
                                                                            <label class="mb-0">Robi Boighor</label>
                                                                        </div>
                                                                        <div class="col-sm-12">
                                                                    ...
                                                                    <div class="row mt-3">
                                                                        <div class="col-sm-12">
                                                                            <label class="mb-0">Airtel Pocketbook</label>
                                                                        </div>
                                                                        <div class="col-sm-12">
                                                                    ...
                                                                    <div class="row mt-3">
                                                                        <div class="col-sm-12">
                                                                            <label class="mb-0">Banglalink Boighor</label>
                                                                        </div>
                                                                        <div class="col-sm-12">
                                                                    ...
                                                                    <div class="row mt-3">
                                                                        <div class="col-sm-12">
                                                                            <label class="mb-0">Legacy</label>
                                                                        </div>
                                                                        <div class="col-sm-12">
                                                                            <input type="checkbox" name="my-checkbox" data-bootstrap-switch data-on-color="success" data-label-text="<span class='fa fa-broadcast-tower'></span>" id="chk_status" <?php echo $status ? 'checked' : '' ?>>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row justify-content-between mt-3">
                                                                        <div class="col-sm-12">
                                                                            <button type="submit" class="btn btn-outline-danger btn-block"><i class="fas fa-save mr-1"></i><b>Save</b></button>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                            </div>
